...
{   
    public class IConfigAdapter : CrossBindingAdaptor
    {
        ...
        static CrossBindingMethodInfo<ShipDock.ByteBuffer> mParse_1 = new CrossBindingMethodInfo<ShipDock.ByteBuffer>("Parse");
        ...
        public override Type BaseCLRType
        {
            get
            {
                return typeof(ShipDock.IConfig);
            }
        }
        ...
        public class Adapter : ShipDock.IConfig, CrossBindingAdaptorType
        {
            ...
            public void Parse(ShipDock.ByteBuffer buffer)
            {
