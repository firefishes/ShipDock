namespace ShipDock.UIControls
{
    ...
    {
        /// <summary>清理控件</summary>
        public const string RAW_DURING_CLEAN = "DuringClean";
    ...
    {
        public const string UI_LABEL = "Label";
        public const string UI_BTN = "Btn";
        public const string UI_BTN_ON = "BtnOn";
        public const string UI_BTN_OFF = "BtnOff";
    }
}
