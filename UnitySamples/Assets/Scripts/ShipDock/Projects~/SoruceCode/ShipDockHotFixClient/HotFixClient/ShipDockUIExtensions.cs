...
namespace ShipDock.Datas
{
    ...
    {
        private System.Collections.Generic.List<int> mDataProxyNames;
        private DataProxy[] mProxyList;

        public DataProxyCacher(params DataProxy[] proxies)
        {
            mDataProxyNames = new System.Collections.Generic.List<int>();
        ...
        public void DataNotify(int dataName, params int[] keyName)
        {
