...
namespace Peace
{
    ...
    public class UIHeadquartersModular : UIModularImpl<UIHeadquarters, IHeadquartersUI>
    {
        public override string ABName { get; } = Consts.AB_UI_HEADQUARTERS;
        public override string UIAssetName { get; protected set; } = Consts.U_HEADQUARTERS;
        public override string Name { get; protected set; } = Consts.UM_HEADQUARTERS;
